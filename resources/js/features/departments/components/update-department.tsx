...
export const UpdateDepartment = ({ departmentId }: UpdateDepartmentProps) => {
  ...
  if(!department || departmentQuery.isPending){
    return null
  }

  const isFetching = useIsFetching();
  const form = useForm<z.infer<typeof updateDepartmentInputSchema>>({
  ...
  async function onSubmit(values: z.infer<typeof updateDepartmentInputSchema>) {
    ...
    updateDepartmentMutation.mutate({ data : values, departmentId : department?.id!})
  }
