...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            ...
            $table->string('tax_number',100)->after('phone_number');
            $table->string('insurance_name',100)->after('phone_number');
            $table->string('insurance_number',100)->after('phone_number');
    ...
    public function down(): void
    {
        Schema::table('employees', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('employees', 'employee_status')) $table->dropColumn('employee_status');
