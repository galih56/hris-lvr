...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('career_transitions', function (Blueprint $table) {
            ...
            $table->unsignedInteger('prev_directorate_id')->nullable();
            $table->unsignedBigInteger('prev_cost_center_id');
            $table->unsignedBigInteger('prev_employment_status_id');
            ...
            $table->unsignedInteger('new_directorate_id')->nullable();
            $table->unsignedInteger('new_job_grade_id');
            $table->unsignedBigInteger('new_cost_center_id');
            $table->unsignedBigInteger('new_employment_status_id');
            ...
            $table->datetime('transition_date')->notNullable();

            // Previous employment info
            $table->foreign('prev_directorate_id')->references('id')->on('directorates');
            ...
            // New employment info
            $table->foreign('new_directorate_id')->references('id')->on('directorates');
